...
st.write(f"**Monthly Income ({selected_month}):** ${monthly_income_value:.2f}")
st.write(f"**Monthly Expense ({selected_month}):** ${monthly_expense_value:.2f}")
st.write(f"**Monthly Saving ({selected_month}):** ${monthly_expense_value:.2f}")
st.markdown("---")
